...
$GLOBALS['_g_line_break_class_table'] =
	array(
		UC_LINE_BREAK_OP => array(
			UC_LINE_BREAK_OP => LB_PROHIBITED,
		...
		UC_LINE_BREAK_CL => array(
			UC_LINE_BREAK_OP => LB_DIRECT,
			UC_LINE_BREAK_CL => LB_PROHIBITED,
		...
		UC_LINE_BREAK_GL => array(
			UC_LINE_BREAK_OP => LB_INDIRECT,
			UC_LINE_BREAK_CL => LB_PROHIBITED,
			UC_LINE_BREAK_QU => LB_INDIRECT,
			UC_LINE_BREAK_GL => LB_INDIRECT,
			UC_LINE_BREAK_NS => LB_INDIRECT,
