	...
	$fieldset_data['elements'][] = array(
	    ...
	    'fields' => array(
		    function() use (&$finance,$locked){
                ...
                <input type="text" name="sub_amount" id="finance_sub_amount" value="<?php echo htmlspecialchars(number_out($finance['sub_amount']));?>" class="currency" autocomplete="off">
                <?php }
		    }
	    ),
    );
	$fieldset_data['elements'][] = array(
	    ...
	    'fields' => array(
		    function() use (&$finance,$locked){
                ...
                <?php echo currency('');?>
                <input type="text" name="taxable_amount" id="finance_taxable_amount" value="<?php echo htmlspecialchars(number_out($finance['taxable_amount']));?>" class="currency" autocomplete="off">
                <?php } ?>
                <?php
		    },
		    array(
