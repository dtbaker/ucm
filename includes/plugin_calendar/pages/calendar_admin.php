...
<script src="<?php echo $base_path; ?>src/Plugins/jquery.calendar.js?ver=<?php echo _SCRIPT_VERSION; ?>"
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        function Delete(data, callback) {
            ...
            hiConfirm("<?php _e( 'Are You Sure to Delete this Event' );?>", 'Confirm', function (r) {
                r && callback(0);
            });
        }
	...
	<div id="calhead" style="padding-left:1px;padding-right:1px;">
		<div class="cHead">
			...
			<div id="errorpannel" class="ptogtitle loaderror"
			     style="display: none;"><?php _e( 'Sorry, could not load your data, please try again later' ); ?></div>
		</div>

		<div id="caltoolbar" class="ctoolbar">
			<?php if ( module_calendar::can_i( 'create', 'Calendar' ) ) { ?>
			...
			<div id="showdaybtn"
			     class="fbutton<?php echo module_config::c( 'calendar_default_view' ) == 'day' ? ' fcurrent' : ''; ?>">
				<div><span title='Day' class="showdayview"><?php _e( 'Day' ); ?></span></div>
			</div>
			<div id="showweekbtn"
			     class="fbutton<?php echo module_config::c( 'calendar_default_view' ) == 'week' ? ' fcurrent' : ''; ?>">
				<div><span title='Week' class="showweekview"><?php _e( 'Week' ); ?></span></div>
			</div>
			<div id="showmonthbtn"
			     class="fbutton<?php echo module_config::c( 'calendar_default_view' ) == 'month' ? ' fcurrent' : ''; ?>">
