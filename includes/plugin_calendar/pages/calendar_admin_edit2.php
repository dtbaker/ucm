...
<link href="<?php echo $base_path; ?>css/dp.css" rel="stylesheet"/>
<link href="<?php echo $base_path; ?>css/dropdown.css" rel="stylesheet"/>
...
<script src="<?php echo $base_path; ?>src/Plugins/jquery.form.js" type="text/javascript"></script>
<script src="<?php echo $base_path; ?>src/Plugins/jquery.validate.js" type="text/javascript"></script>
<script src="<?php echo $base_path; ?>src/Plugins/jquery.dropdown.js" type="text/javascript"></script>
...
<style type="text/css">
	.calpick {
		...
		border: none;
		cursor: pointer;
		background: url("<?php echo $base_path;?>css/images/cal.gif") no-repeat center 2px;
		margin-left: -22px;
	}
</style>
...
<div>
	...
	<div class="infocontainer">
		<form action="php/datafeed.php?method=adddetails<?php echo isset( $event ) ? "&id=" . $event->Id : ""; ?>"
            ...
            <span>                        *Subject:
				...
				<input MaxLength="200" class="required safe" id="Subject" name="Subject" style="width:85%;" type="text"
				       value="<?php echo isset( $event ) ? $event->Subject : "" ?>"/>
            ...
            <span>*Time:
				...
				<div>
					...
					<input MaxLength="10" class="required date" id="stpartdate" name="stpartdate"
					       style="padding-left:2px;width:90px;" type="text"
					       value="<?php echo isset( $event ) ? $sarr[0] : ""; ?>"/>
					<input MaxLength="5" class="required time" id="stparttime" name="stparttime" style="width:40px;" type="text"
					       value="<?php echo isset( $event ) ? $sarr[1] : ""; ?>"/>To
					<input MaxLength="10" class="required date" id="etpartdate" name="etpartdate"
					       style="padding-left:2px;width:90px;" type="text"
					       value="<?php echo isset( $event ) ? $earr[0] : ""; ?>"/>
					<input MaxLength="50" class="required time" id="etparttime" name="etparttime" style="width:40px;" type="text"
					       value="<?php echo isset( $event ) ? $earr[1] : ""; ?>"/>
					<label class="checkp">
						<input id="IsAllDayEvent" name="IsAllDayEvent" type="checkbox"
						       value="1" <?php if ( isset( $event ) && $event->IsAllDayEvent != 0 ) {
							echo "checked";
						} ?>/> All Day Event
					</label>
				</div>
