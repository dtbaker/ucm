	...
	<table class="tableclass tableclass_rows">
		...
		foreach ( $menu_items as $menu_id => $menu_data ) {
			...
			<tr class="<?php echo $c ++ % 2 ? 'odd' : 'even'; ?>">
				...
				<td>
					<input type="text" name="save_menu_config[<?php echo htmlspecialchars( $menu_id ); ?>][order]"
					       value="<?php echo htmlspecialchars( $menu_data['order'] ); ?>" size="6">
				</td>
				<td>
					<input type="text" name="save_menu_config[<?php echo htmlspecialchars( $menu_id ); ?>][icon]"
					       value="<?php echo htmlspecialchars( $menu_data['icon'] ); ?>" size="6">
				</td>
				<td>
					<?php
