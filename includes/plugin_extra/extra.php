...
class module_extra extends module_base{
    ...
    public static function get_display_value( $extra_data ){
        ...
        $default = get_single('extra_default',array('owner_table','extra_key'),array($extra_data['owner_table'],$extra_data['extra_key']));
                ...
                case 'ajax':
                    ...
                    if($lookup && !empty($lookup['lookup'])){
                        ...
                        $search_options = array(
                            'plugin' => $bits[0],
                            'return_more' => true, // return an array of more details so invoice can display extra details. currently only used in 'data' module
